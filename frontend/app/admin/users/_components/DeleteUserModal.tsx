...
export default function DeleteUserModal({ user, isDeleting, onCancel, onConfirm }: Props) {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
            <div className="w-full max-w-sm rounded-xl bg-white p-6 text-center">
                ...
                <p className="mt-2 text-sm text-gray-500">
                    This will permanently delete <span className="font-semibold">{user.fullName}</span> ({user.email}). This action cannot be undone.
                </p>
